...
> 架构是系统的骨架。代码解决的是"怎么写"，架构解决的是"怎么拆、怎么合、怎么演进"。本章回答三个问题：什么是软件架构？经典架构模式各自解决什么问题？如何在不过度设计的前提下，为系统选择合适的分层策略？
...
前面讨论的约束都是技术层面的——用户规模、成本、性能。但架构决策中最大的非技术约束是**团队组织结构**。
