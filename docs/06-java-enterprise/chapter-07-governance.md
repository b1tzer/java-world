...
> **纵横联系**
>
> - **与第六卷第6章《微服务架构》的关系**：本章的配置中心、容错、限流是微服务治理的具体落地实践，第五卷侧重架构设计思想，本章侧重工程实现
> - **与第六卷第 9 章《可观测性》的关系**：链路追踪是可观测性三大支柱之一（日志、指标、追踪），本章介绍追踪的基本概念和 SkyWalking 实践，第 9 章将从全局视角串联三大支柱
> - **与第六卷第 8 章《企业系统安全与部署》的关系**：在 Kubernetes 环境中，配置中心的 Namespace 可以与 K8s 的 Namespace 对齐，Sentinel 的限流规则也可以通过 ConfigMap 下发
