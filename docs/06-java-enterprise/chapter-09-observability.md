...
> - **与第四卷《数据库与存储》的关系**：慢 SQL 是接口变慢的最常见原因之一，链路追踪可以精确到每条 SQL 的执行耗时，指标监控可以观察数据库连接池状态
> - **与第五卷《微服务架构》的关系**：微服务架构放大了可观测性的难度——一个请求跨越多个服务，必须依靠分布式追踪才能定位问题。本章的排查方法论是微服务运维的必备技能
