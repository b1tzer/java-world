...
| 章 | 定位 | 认知负荷 | 提前看下一章？ |
|----|------|---------|--------------|
| 第1章 网络基础 | 铺垫 | 低 | 不用，但第2、3章会重复核心概念 |
| 第2章 TCP/IP | 深水区 | 高 | §2.3 读完可暂停，歇口气再继续 |
| 第3章 Socket | 核心 | 中 | 与第4章前后呼应，建议连着读 |
| 第4章 NIO | 核心 | 高 | §4.1 读完可直接跳到 §4.5 Selector |
| 第5章 Netty | 实战 | 中 | 需要第4章的 Selector/Reactor 基础 |
| 第6章 HTTP | 应用 | 低 | 独立性强，可跳读 |
| 第7章 Servlet/Spring MVC | 实战 | 中 | 标注了快速路径和深入路径，可按需读 |
| 第8章 RPC | 实战 | 中 | 依赖第3章 Socket，建议读完后读 |
| 第9章 长连接 | 进阶 | 中 | 可选，不影响其他章理解 |
| 第10章 网络诊断 | 工具 | 低 | 独立，任何时候都可以翻 |
