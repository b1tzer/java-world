...
```text
    客户端 (Client)                          服务端 (Server)
        ...
        │                                        │     (我想连接你，我的初始序列号是 x)
        │                                        │
        │  ◀── SYN+ACK, seq=y, ack=x+1 ───────  │  ② 服务端回复 SYN+ACK
        │                                        │     (同意连接，我的初始序列号是 y，
        │                                        │      确认你的序列号 x+1)
        │                                        │
